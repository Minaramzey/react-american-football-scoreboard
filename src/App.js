    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className="homeButtons__touchdown-exraPoint" onClick={ ()=> setHome( home + 1)}>Home Extra Point</button>
        ...
        <div className="awayButtons">
          ...
          <button className="awayButtons__touchdown-extraPoint"onClick={ ()=> setAway( away + 1)}>Away Extra Point</button>
